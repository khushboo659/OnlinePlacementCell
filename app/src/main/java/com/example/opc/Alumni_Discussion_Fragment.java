...
public class Alumni_Discussion_Fragment extends Fragment {
    ...
    FirebaseAuth auth;
    //variable for Firebase user(stores current user)
    FirebaseUser user;
    //variable for reference of experience node of database
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        //getting curent user and its email
        ...
        //storing reference of experience (child of root) of database
        root= FirebaseDatabase.getInstance().getReference().child("experience");
        //action to be occured on pressing send button
        sendbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //taking message as input from user and storing it in text var
                text=input_msg.getText().toString();
                //putting msg and email in hashmap
                HashMap<String, String> map2=new HashMap<String, String>();
                map2.put("msg",text);
                map2.put("name",em);
                Log.i("info",text+"By"+em);
                //message_root.updateChildren(map2);
                //pushing map as a value of random key generated by push() as a child of message.
        ...
        //action to be performed when child is added or changed in message section of database
    ...
    //appending all the messages prev and currently sended in text view and displaying it in textView.
